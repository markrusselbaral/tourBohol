...
@section('content')
<form action="{{ route('destination.save') }}" method="POST" enctype="multipart/form-data">
   @csrf
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h6 class="modal-title m-0" id="exampleModalDefaultLabel">Add Destination Content</h6>
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="mb-3">
                           <label for="textContent">Title</label>
                           <input type="text" name="title" id="textContent" class="form-control">
                        </div>
                        <div class="mb-3">
...
<form action="{{ route('destination.update') }}" method="POST" enctype="multipart/form-data">
   ...
   <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalDefaultLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h6 class="modal-title m-0" id="exampleModalDefaultLabel">Edit Destination Content</h6>
               <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <!--end modal-header-->
            <div class="modal-body">
                  ...
                  <div class="card">
                     ...
                     <div class="mb-3">
                        ...
                        <div class="mb-3">
                           ...
                           <textarea name="description" id="editDescription" cols="10" rows="5" class="form-control"></textarea>
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title">Destination Contents</h4>
                  </div>
                  <!--end card-header-->
                  <div class="card-body">
                        ...
                        <table class="table" id="datatable_1">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <img src="{{ asset('storage/destination/'.$contents->image) }}" width="50px" height="50px">
                                 </td>
                                 <td>
                                    <form action="{{ route('destination.delete') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                                       @csrf
                                       @method('DELETE')
    ...
    $(document).on('click', '.editbtn', function () {
        ...
        $.ajax({
           ...
           success: function (response) {
                ...
                $('#currentImage').attr('src', '{{ asset('storage/destination/') }}' + '/' + response.image);
