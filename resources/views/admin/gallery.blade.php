      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h6 class="modal-title m-0" id="exampleModalDefaultLabel">Edit Gallery Content</h6>
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="mb-3">
                           ...
                           <input type="text" name="text" id="textContent" class="form-control">
                        </div>
                        <div class="mb-3">
                  ...
                  <div class="card">
                     <div class="card-body">
                        <div class="mb-3">
                           ...
                           <input type="text" name="text" id="editText" class="form-control">
                        </div>
                        <div class="mb-3">
            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-header">
                     <h4 class="card-title">Gallery Contents</h4>
                  </div>
                  <!--end card-header-->
                  <div class="card-body">
                        ...
                        <table class="table" id="datatable_1">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <td>{{ $contents->text }}</td>
                                 <td>
                                    <img src="{{ asset('storage/gallery/'.$contents->image) }}" width="50px" height="50px">
                                 </td>
                                 <td>
                                    <form action="{{ route('gallery.delete') }}" method="POST" onsubmit="return confirm('Are you sure you want to delete?')">
                                       @csrf
                                       @method('DELETE')
    ...
    $(document).on('click', '.editbtn', function () {
        ...
        $.ajax({
           ...
           success: function (response) {
                ...
                $('#currentImage').attr('src', '{{ asset('storage/gallery/') }}' + '/' + response.image);
